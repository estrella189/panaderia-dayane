...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    /* Cel grandes */
    @media (max-width: 768px){ header{padding:18px 12px} header h1{font-size:20px;gap:8px;flex-direction:row !important} header h1 img{width:34px} nav{padding:8px 6px;overflow-x:auto;white-space:nowrap} nav a{display:inline-block;padding:8px 12px;margin:4px;font-size:15px} main{margin:18px auto 40px;padding:0 12px} section.products{grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:16px} .product-card{border-radius:18px} .product-card img{height:210px;padding:8px} }
    /* Cel pequeños */
    @media (max-width: 480px){ header h1{font-size:18px;gap:6px;flex-direction:row !important} header h1 img{width:28px} nav a{padding:7px 10px;font-size:14px;margin:3px} section.products{grid-template-columns:1fr;gap:14px} .product-card img{height:180px} }
  </style>
</head>
<body>
  <header>
  ...
  <main>
    <section class="products">
      @php
        $items = [
          ['img'=>'fresasfileteada.jpg','nombre'=>'Pastel de Fresas Fileteadas'],
          ['img'=>'frutas kiwi.jpg','nombre'=>'Pastel de Frutas con Kiwi'],
          ['img'=>'frutas1.jpg','nombre'=>'Pastel de Frutas Variadas '],
          ['img'=>'nuezcondurazno.jpg','nombre'=>'Pastel Nuez con Durazno'],
          ['img'=>'pastel de fresa con granola.jpg','nombre'=>'Pastel de Fresa con Granola'],
          ['img'=>'pastel de frutas cruz.jpg','nombre'=>'Pastel de Frutas Cruz'],
          ['img'=>'pastel de mango.jpg','nombre'=>'Pastel de Mango'],
          ['img'=>'pastel de frutas.jpg','nombre'=>'Pastel de Frutas '],
          ['img'=>'pastel tres leches mango.jpg','nombre'=>'Pastel de Tres Leches con Mango'],
          ['img'=>'pstel tres filas_frutas.jpg','nombre'=>'Pastel de Tres Filas de Frutas'],
        ];
      @endphp

      @foreach($items as $it)
      <article class="product-card">
      <img src="{{ asset('img/pasteles/frutas/' . $it['img']) }}" alt="{{ $it['nombre'] }}">
        <div class="card-body">
