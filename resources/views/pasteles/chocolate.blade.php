...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .btn{ padding:10px 14px; border-radius:999px; border:none; color:#fff; background:#8b5e3c; cursor:pointer; text-decoration:none; text-align:center; display:inline-block; }
    ...
    @media (max-width: 480px){
      header h1{font-size:18px;gap:6px}
        ...
        <div class="card-body">
          ...
          <form method="POST" action="{{ route('cotizaciones.store') }}" class="grid" style="display:grid;gap:8px">
            ...
            <label>Mensaje (opcional)
              <input class="input" type="text" name="mensaje_pastel" maxlength="255" placeholder="Feliz cumple...">
            </label>
