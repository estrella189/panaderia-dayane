...
<body>
  <header>
    <h1> Pasteles de chocolate - Dayane </h1>
  </header>
      ...
      <article class="product-card">
       <img src="{{ asset('img/pasteles/chocolate/pastel de chocolate.jpg') }}" alt="Pastel de Chocolate">
        <div class="card-body">
          ...
          @auth
          <form method="POST" action="{{ route('pedidos.crear_rapido') }}" class="grid" style="display:grid;gap:8px">
            @csrf
            ...
            <label>Mensaje (opcional) <input class="input" type="text" name="mensaje_pastel" maxlength="255" placeholder="Feliz cumple..."></label>
