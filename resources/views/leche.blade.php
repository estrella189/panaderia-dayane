...
@media (max-width: 768px) {
  ...
  nav {
    padding: 8px 6px;
    overflow-x: auto;      /* scroll horizontal si no caben los links */
    white-space: nowrap;
  }
...
<body>
  ...
  <main>
    <!-- Productos -->
    <section id="leche" class="products">

      <article class="product-card">
        <img src="leche_lala.png" alt="Leche LALA">
        <div class="product-content">
          <h3>Leche Lala Entera</h3>
          <p class="price">$33</p>
        </div>
      </article>

      <article class="product-card">
        <img src="leche_nutri.jpg" alt="Nutri Clasica">
        <div class="product-content">
          <h3>Nutri Clasica</h3>
          <p class="price">$26</p>
        </div>
      ...
      <article class="product-card">
        <img src="durazno.jpg" alt="Yogurt de Durazno">
        <div class="product-content">
          <h3>Yogurt de durazno</h3>
          <p class="price">$17</p>
        </div>
      </article>
      ...
      <article class="product-card">
        <img src="fresa.jpg" alt="Yogurt de Fresa">
        <div class="product-content">
          <h3> Yogurt de fresa</h3>
          <p class="price">$17</p>
        </div>
      </article>
      
      <article class="product-card">
        <img src="piñacoco.jpg" alt="Yogurt de Piña con coco">
        <div class="product-content">
          <h3>Yogurt piña-coco</h3>
          <p class="price">$17</p>
        </div>
      </article>
      ...
      <article class="product-card">
        <img src="chocolala.jpg" alt="chocolala">
        <div class="product-content">
          <h3>chocolala</h3>
          <p class="price">$25</p>
        </div>
