...
<style>
    :root {
        --primary:rgba(129, 65, 1, 0.86);  /* Café cálido */
        --primary-dark:rgba(108, 53, 5, 0.76);
        --secondary:  #5c3a21;  /* Café oscuro elegante */
        --light: #FFF8F0;  /* Beige muy claro */
        --lighter: #F5E9DC;
        --lightest: #EDE0D1;
        --border: #D4B996;  /* Borde café claro */
        --warning: #E3B04B;  /* Dorado cálido */
        --warning-dark: #D4A037;
        --danger: #C45C4D;  /* Rojo terracota */
        --danger-dark: #B34C3D;
